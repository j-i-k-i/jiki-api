...
2. **Verify output**: Check `typescript/dist/nodes.d.ts`

3. **Commit changes**: Only commit source files, not generated dist/
...
### What to Commit
- ✅ Source files: `typescript/src/*.ts`
- ✅ Config files: `package.json`, `tsconfig.json`, etc.
- ✅ Generator code: `lib/typescript_generator/**/*.rb`

### What NOT to Commit
- ❌ `typescript/dist/` (generated files)
- ❌ `typescript/node_modules/` (dependencies)
- ❌ Lock files: `pnpm-lock.yaml`, `package-lock.json`

These are gitignored and generated by `rake typescript:generate`.
