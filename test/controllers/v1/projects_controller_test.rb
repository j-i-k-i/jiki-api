...
class V1::ProjectsControllerTest < ApplicationControllerTest
  setup do
    setup_user
  end

  # Authentication guards
  guard_incorrect_token! :v1_projects_path, method: :get
  ...
  test "GET index returns projects with unlocked first, then locked" do
    ...
    get v1_projects_path, headers: @headers, as: :json
  ...
  test "GET index filters by title parameter" do
    ...
    get v1_projects_path(title: "Calculator"), headers: @headers, as: :json
  ...
  test "GET index supports pagination with page parameter" do
    ...
    get v1_projects_path(page: 1, per: 2), headers: @headers, as: :json
  ...
  test "GET index supports pagination with per parameter" do
    ...
    get v1_projects_path(per: 3), headers: @headers, as: :json
