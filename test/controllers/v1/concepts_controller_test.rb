...
class V1::ConceptsControllerTest < ApplicationControllerTest
  setup do
    setup_user
  end

  # Authentication guards
  guard_incorrect_token! :v1_concepts_path, method: :get
  guard_incorrect_token! :v1_concept_path, args: ["some-concept"], method: :get
  ...
  test "GET index returns unlocked concepts by default (scoped)" do
    ...
    get v1_concepts_path, headers: @headers, as: :json
  ...
  test "GET index with unscoped=true returns all concepts" do
    Prosopite.finish
    concept_1 = create(:concept, title: "Arrays")
    create(:concept, title: "Strings")
    ...
    get v1_concepts_path(unscoped: "true"), headers: @headers, as: :json
  ...
  test "GET index filters by title parameter" do
    ...
    get v1_concepts_path(title: "String"), headers: @headers, as: :json
  ...
  test "GET index supports pagination with page parameter" do
    ...
    get v1_concepts_path(page: 1, per: 2), headers: @headers, as: :json
  ...
  test "GET index supports pagination with per parameter" do
    ...
    get v1_concepts_path(per: 3), headers: @headers, as: :json
  ...
  test "GET show returns unlocked concept with full details" do
    ...
    get v1_concept_path(slug: concept.slug), headers: @headers, as: :json
  ...
  test "GET show with unscoped=true returns locked concept" do
    concept = create(:concept, title: "Arrays")
    # Not unlocked for user

    get v1_concept_path(concept.slug, unscoped: "true"), headers: @headers, as: :json
  ...
  test "GET show returns 404 for non-existent concept" do
    get v1_concept_path(slug: "non-existent-slug"), headers: @headers, as: :json
  ...
  test "GET show works with slug history" do
    ...
    get v1_concept_path(slug: "original-slug"), headers: @headers, as: :json
