...
class V1::Projects::ExerciseSubmissionsControllerTest < ApplicationControllerTest
  setup do
    setup_user
  ...
  test "POST create successfully creates submission" do
    ...
    Prosopite.pause do
      post v1_project_exercise_submissions_path(project_slug: @project.slug),
  ...
  test "POST create handles invalid project slug" do
    ...
    post v1_project_exercise_submissions_path(project_slug: "nonexistent"),
      params: { submission: { files: } },
      headers: @headers,
      as: :json
