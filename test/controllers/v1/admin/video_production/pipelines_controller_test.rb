...
class V1::Admin::VideoProduction::PipelinesControllerTest < ApplicationControllerTest
  setup do
  ...
  guard_admin! :v1_admin_video_production_pipeline_path, args: ['test-uuid'], method: :get
  guard_admin! :v1_admin_video_production_pipelines_path, method: :post
  guard_admin! :v1_admin_video_production_pipeline_path, args: ['test-uuid'], method: :patch
  guard_admin! :v1_admin_video_production_pipeline_path, args: ['test-uuid'], method: :delete
  ...
  test "GET index returns all pipelines with pagination meta" do
    ...
    get v1_admin_video_production_pipelines_path, headers: @headers, as: :json
  ...
  test "GET index paginates results" do
    ...
    Prosopite.scan
    get v1_admin_video_production_pipelines_path(page: 1, per: 2),
      headers: @headers,
      as: :json
  ...
  test "POST create creates a new pipeline" do
    ...
    assert_difference 'VideoProduction::Pipeline.count', 1 do
      post v1_admin_video_production_pipelines_path,
  ...
  test "PATCH update can update title" do
    ...
    Prosopite.scan
    patch v1_admin_video_production_pipeline_path(pipeline.uuid),
  ...
  test "PATCH update returns 404 for non-existent pipeline" do
    patch v1_admin_video_production_pipeline_path('non-existent-uuid'),
  ...
  test "DELETE destroy deletes pipeline and cascades to nodes" do
    ...
    assert_difference 'VideoProduction::Pipeline.count', -1 do
      assert_difference 'VideoProduction::Node.count', -2 do
        Prosopite.scan
        delete v1_admin_video_production_pipeline_path(pipeline.uuid),
          headers: @headers,
          as: :json
      end
    end
  ...
  test "DELETE destroy returns 404 for non-existent pipeline" do
    delete v1_admin_video_production_pipeline_path('non-existent-uuid'),
      headers: @headers,
      as: :json
