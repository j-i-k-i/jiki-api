...
Devise.setup do |config|
  ...
  # config.secret_key = '8bed2b4cba175b3e398a5d19206f476836ff8bc441be6491ae8ab148eb143c37d60d151a20d5dc183c80a78716cfe6ee3afc8090d455074c7007a2b736831ab8'
  ...
  config.mailer_sender = ENV.fetch('MAILER_FROM', 'noreply@jiki.app')
  ...
  # For API-only mode, we don't use HTTP Auth
  ...
  # config.pepper = '4e6f0283caf2072cb62b02acc4bc3973495e359b10f460c2915dfe6744c943a82c9c96f95892ce767221de0ad10057730ff8bd532c2f83465f9d60f0ba493a22'
  ...
  # API-only mode: No navigational formats (no redirects)
  config.navigational_formats = []

  # The default HTTP method used to sign out a resource. Default is :delete.
  # API-only mode: Allow DELETE for sign out
